...
const (
	// EnvDisableVirtioWatchdog disables the virtio_net watchdog when set to a
	// truthy value at boot.
...
// VirtioWatchdogDisabled reports whether the watchdog is disabled via the
